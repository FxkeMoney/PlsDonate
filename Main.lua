...
if game.PlaceId ~= 18852429314 and game.PlaceId ~= 18852429314 then
	return
end
...
if queueonteleport then
	queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/FxkeMoney/PlsDonate/refs/heads/main/Main.lua'))()")
end
